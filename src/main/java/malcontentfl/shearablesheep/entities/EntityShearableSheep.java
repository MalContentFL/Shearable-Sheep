...
public class EntityShearableSheep extends EntityAnimal implements net.minecraftforge.common.IShearable
{
    private static final DataParameter<Byte> DYE_COLOR = EntityDataManager.<Byte>createKey(EntityShearableSheep.class, DataSerializers.BYTE);
    /**
    ...
    {
        EntityLiving.registerFixesMob(fixer, EntityShearableSheep.class);
    }
    ...
    public EntityShearableSheep createChild(EntityAgeable ageable)
    {
    	EntityShearableSheep entitysheep = (EntityShearableSheep)ageable;
    	EntityShearableSheep entitysheep1 = new EntityShearableSheep(this.worldObj);
    ...
    {
        int i = ((EntityShearableSheep)father).getFleeceColor().getDyeDamage();
        int j = ((EntityShearableSheep)mother).getFleeceColor().getDyeDamage();
        this.inventoryCrafting.getStackInSlot(0).setItemDamage(i);
        this.inventoryCrafting.getStackInSlot(1).setItemDamage(j);
        ItemStack itemstack = CraftingManager.getInstance().findMatchingRecipe(this.inventoryCrafting, ((EntityShearableSheep)father).worldObj);
        int k;
